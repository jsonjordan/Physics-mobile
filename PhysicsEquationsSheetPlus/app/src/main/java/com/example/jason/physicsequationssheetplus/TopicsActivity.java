...
public class TopicsActivity extends ListActivity {
    ...
    protected void onListItemClick(ListView l, View v, int position, long id){
        ...
        switch(position){
            case 0:
                startActivity(new Intent(TopicsActivity.this, EquationSheetActivity.class));
                break;
            case 1:
                startActivity(new Intent(TopicsActivity.this, KinamaticsActivity.class));
                break;
            case 2:
                startActivity(new Intent(TopicsActivity.this, ForcesActivity.class));
                break;
            case 3:
